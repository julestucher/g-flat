...
//  http://fsprojects.github.io/FnuPlot/index.html
// ----------------------------------------------------------------------------
module FnuPlot
...
type GnuPlot private (actualPath:string) =
  ...
  let gp = 
    ...
    | :? System.FormatException as e ->
      printfn "Error starting gnuplot: Make sure that your PATH variable is set"
      exit(1)
